        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            ...
            <p>
              ...
              статистику, для этого просто доставьте "+" в конце URL. Например,
              если вы получили ссылку surl.li/clck — статистика этой ссылки
              находиться по адресу surl.li/clck+. Вы увидите количество кликов и
              переходов, локации посетителей их устройства и браузеры. Одним
              словом — все что может понадобиться хорошему маркетологу для
              хорошей работы. Главное, чтобы длинна исходной ссылки перед ее
